...
export const Maintenance: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // /admin/backup/list est réservé au super_admin ; un admin simple recevait un 403
    // silencieux (toast d'erreur) à chaque chargement de la page.
    if (isSuperAdmin) {
      fetchBackups();
    } else {
      setLoading(false);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Sauvegardes : réservées au super_admin */}
      {isSuperAdmin && (
        <div className="bg-white rounded-lg border border-gray-200 p-6">
